# Git Branch Source vs. GitHub Branch Source

In Jenkins/CloudBees CI, there’s a **big difference between using the plain Git Branch Source vs. the GitHub Branch Source** in a Multibranch Pipeline (or Organization Folder).
